module.exports = function(app) {
  console.log("YEE");
    ...
    var hosted_logins = 'https://rq4dyuj1.e1.loginrocket.com/'
    var token = null;
    var AuthRocket = require('authrocket');
    var authrocket = new AuthRocket({jsUrl: 'https://rq4dyuj1.e1.loginrocket.com/',
    });  
 ...
 exports.verify = function(dest, res){
  ...
  if (err) {
    ...
    return res.redirect('https://rq4dyuj1.e1.loginrocket.com/');
  }else{
